...
[x]6. Избавиться от editing в БД и на фронте
...
[x]14. Исправить баг с исправлением, когда значение не поменялось
[x]15. Перенести кнопку удалить в подробнее
[x]16. Баг появлением окна редактирования при нажатии checkbox и удалить
[x]17. Баг с закрытием модального окна (временно)
[ ]18. Перенести все стили из шаблонов в sass файлы
[x]19. Стилизовать окно редактирования
[x]20. Подтверждение E-mail
  [x]20.1 Стилизовать email письмо
  [x]20.2 Стилизовать старницы succses/error
  [x]20.3 Создать email для проекта todo
[ ]21. При нажатии esc закрывать окно редактирования
[ ]22. Баг с закрытием модального окна
[ ]23. Валидация для неактивированного пользователя
```
